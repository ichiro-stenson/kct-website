    ...
    <>
      ...
      <section className="relative bg-[#0f1e3c] pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-[#E8142D] font-semibold uppercase tracking-widest text-sm mb-3">About Us</p>
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-14 items-center">
            ...
            <div>
              <p className="text-[#E8142D] font-semibold uppercase tracking-widest text-sm mb-3">Our Story</p>
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="text-[#E8142D] font-semibold uppercase tracking-widest text-sm mb-3">What Drives Us</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {values.map(v => (
              <div key={v.title} className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 text-center">
                <div className="w-14 h-14 bg-[#E8142D]/10 rounded-2xl flex items-center justify-center mx-auto mb-5">
                  <v.icon className="w-7 h-7 text-[#E8142D]" />
                </div>
      ...
      <section className="bg-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <p className="text-[#E8142D] font-semibold uppercase tracking-widest text-sm mb-3">Our Journey</p>
              ...
              {milestones.map((m, i) => (
                <div key={i} className="flex items-start gap-6 pl-16 relative">
                  <div className="absolute left-0 w-12 h-12 bg-[#0f1e3c] rounded-full flex items-center justify-center border-4 border-white shadow-lg">
                    <span className="text-[#E8142D] font-bold text-xs">{m.year.slice(2)}</span>
                  </div>
                  <div className="bg-gray-50 rounded-xl p-5 flex-1 border border-gray-100">
                    <div className="text-[#E8142D] font-bold text-sm mb-1">{m.year}</div>
      ...
      <section className="bg-[#0f1e3c] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-[#E8142D] font-semibold uppercase tracking-widest text-sm mb-3">Where We Are</p>
