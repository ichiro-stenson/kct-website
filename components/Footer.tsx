        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://www.facebook.com/KingCapitalTransport" target="_blank" rel="noopener noreferrer"
                className="text-gray-400 hover:text-[#E8142D] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li key={l.href}>
                  <Link href={l.href} className="text-gray-400 hover:text-[#E8142D] transition-colors">{l.label}</Link>
                </li>
              ))}
            </ul>
          </div>
            ...
            <ul className="space-y-2 text-sm">
              {locations.map(loc => (
                <li key={loc.city} className="flex items-center gap-2 text-gray-400">
                  <MapPin className="w-3.5 h-3.5 text-[#E8142D] flex-shrink-0" />
                  {loc.city}, {loc.state}
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <a
              ...
              className="inline-block bg-[#E8142D] hover:bg-[#C0101F] text-white font-semibold px-5 py-2.5 rounded-lg text-sm transition-colors"
            >
              Apply Now →
            </a>
          </div>
